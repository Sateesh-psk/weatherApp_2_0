...
const CurrentWeather = () => {
  ...
  return (
    <div className=' h-[70vh] flex items-center justify-center'>
      <div className=' w-full min-sm:grid min-sm:grid-cols-12 min-sm:gap-4 select-none'>
        ...
        <div className=' animate-appear max-sm:mt-10 max-sm:text-center max-sm:justify-self-center min-sm:col-span-6'>
          <img
